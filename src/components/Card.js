  ...
  return (
    <Wrapper className="relative recipe-card h-full" onClick={handleClick}>
      <div className="relative cooked-recipe bg-white cursor-pointer overflow-clip h-full">
        <div className="relative recipe-card-img -z-0">
            <img
              src={recipe.image}
              alt="img"
            />
        </div>
        <div className="recipe-card-content relative h-full w-full">
          <div className="relative title flex justify-center items-center px-2 w-full h-20 max-h-20">
          ...
          <div className="recipe-category p-4 w-full flex justify-center items-center text-sm capitalize ">
            ...
            <span className=" text-gray-500 line-clamp-1 w-24">{recipe.dishTypes[0]}</span>
          </div>
